...
describe("Icon component", () => {
  ...
  // test optionnel
  describe("When an icon is created with the name facebook", () => {
  ...
  describe("When an icon is created with the name twitter", () => {
  ...
  describe("When an icon is created with the name youtube", () => {
